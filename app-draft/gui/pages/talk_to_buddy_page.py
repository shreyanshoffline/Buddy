...
class TalkToBuddyPage(CardPage):
    ...
    def _build_voice_controls(self):
        ...
        self.listening_model_combo.currentIndexChanged.connect(self._refresh_voice_hint)
        self.speaking_model_combo.currentIndexChanged.connect(self._refresh_voice_hint)
