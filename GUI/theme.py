...
def get_theme(accent_key="blue", dark_mode=False):
    ...
    if not dark_mode:
        theme = {
            ...
            "sidebar_bg": "rgba(248, 249, 251, 191)",
            "input_bg": "#ffffff",
            "input_border": "rgba(0, 0, 0, 20)",
            "chat_bubble_agent": "rgba(255, 255, 255, 235)",
        ...
        theme = {
            ...
            "sidebar_bg": "rgba(28, 30, 35, 191)",
            "input_bg": "#26292f",
            "input_border": "rgba(255, 255, 255, 23)",
            "chat_bubble_agent": "rgba(255, 255, 255, 15)",
            "chat_bubble_agent_text": "#e8e9ec",
            "danger": "#ff6b6b",
            "danger_soft": "rgba(255, 107, 107, 31)",
            "danger_border": "rgba(255, 107, 107, 89)",
        }
