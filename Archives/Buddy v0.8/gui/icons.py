...
ICONS = {
    ...
    "artifacts": "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-1 16H6c-.55 0-1-.45-1-1V6c0-.55.45-1 1-1h12c.55 0 1 .45 1 1v12c0 .55-.45 1-1 1zm-8-8h8v2h-8v-2zm0 4h8v2h-8v-2zm0-8h8v2H10V7z",
    ...
    "plugins": "M20.5 11H19V7c0-1.1-.9-2-2-2h-4V3.5C13 2.12 11.88 1 10.5 1S8 2.12 8 3.5V5H4c-1.1 0-2 .9-2 2v4h1.5C4.88 11 6 12.12 6 13.5S4.88 16 3.5 16H2v4c0 1.1.9 2 2 2h4v-1.5C8 19.12 9.12 18 10.5 18s2.5 1.12 2.5 2.5V22h4c1.1 0 2-.9 2-2v-4h1.5c1.38 0 2.5-1.12 2.5-2.5S21.88 11 20.5 11zM17 20h-2v-.5c0-2.48-2.02-4.5-4.5-4.5S6 17.02 6 19.5v.5H4v-2.5C6.48 17.5 8.5 15.48 8.5 13S6.48 8.5 4 8.5V7h4.5C8.5 4.52 10.52 2.5 13 2.5S17.5 4.52 17.5 7H19v4.5c2.48 0 4.5 2.02 4.5 4.5S21.48 20.5 19 20.5V20z",
}
